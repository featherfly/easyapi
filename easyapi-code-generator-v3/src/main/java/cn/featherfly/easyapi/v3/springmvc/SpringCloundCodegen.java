...
import static io.swagger.codegen.v3.generators.features.BeanValidationFeatures.*;
import static io.swagger.codegen.v3.generators.features.OptionalFeatures.*;
...
public abstract class SpringCloundCodegen extends EasyapiAbstractJavaCodegen implements BeanValidationFeatures, OptionalFeatures, NotNullAnnotationFeatures {
    ...
    public SpringCloundCodegen() {
        ...
        cliOptions.add(CliOption.newBoolean(USE_BEANVALIDATION, "Use BeanValidation API " +
                "annotations"));
